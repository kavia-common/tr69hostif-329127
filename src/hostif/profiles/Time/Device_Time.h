 ...
 *  @retval ERR_???       Appropriate error value.
 *
...
public:
     ...
     *
     * This function provides the current date and time in the UTC time zone.
     *
     */
